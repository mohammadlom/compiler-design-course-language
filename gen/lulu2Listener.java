...
public interface lulu2Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link lulu2Parser#np}.
	 * @param ctx the parse tree
	 */
	void enterNp(lulu2Parser.NpContext ctx);
	/**
	 * Exit a parse tree produced by {@link lulu2Parser#np}.
	 * @param ctx the parse tree
	 */
	void exitNp(lulu2Parser.NpContext ctx);
	/**
